 ...
 * Task: T019 [US1] Signup page with form validation
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-secondary relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-20 right-20 w-96 h-96 bg-indigo-400/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold mb-4">Join TaskFlow Today</h1>
            <p className="text-xl text-white/80 leading-relaxed">
              Start organizing your life. Create an account and experience the power of efficient task management.
            </p>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={index} className="flex items-center gap-3 text-white/90">
                <span className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center text-lg">
                  {benefit.icon}
                </span>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gradient-to-br from-slate-50 via-white to-purple-50/30">
        <div className="w-full max-w-md animate-fade-in">
          {/* Mobile Logo */}
          <div className="lg:hidden text-center mb-8">
            <div className="w-14 h-14 bg-gradient-to-br from-violet-600 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-purple-500/30">
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl shadow-gray-200/50 p-8 border border-white/50">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-violet-600 to-purple-600 text-white font-semibold py-3.5 px-6 rounded-xl shadow-lg shadow-purple-500/30 hover:shadow-xl hover:shadow-purple-500/40 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                suppressHydrationWarning
              >
                {loading ? (
            ...
            <Link
              href="/login"
              className="block w-full text-center py-3.5 px-6 rounded-xl border-2 border-gray-200 text-gray-700 font-medium hover:border-purple-300 hover:text-purple-600 hover:bg-purple-50/50 transition-all duration-200"
            >
              Sign in instead
            </Link>
          </div>
